<template>
  <button class="button" @click="handleClick" type="button">
...
.button:hover .button-inner {
  clip-path: inset(
    clamp(1px, 0.0625em, 2px) clamp(1px, 0.0625em, 2px) clamp(1px, 0.0625em, 2px)
      clamp(1px, 0.0625em, 2px) round 100em
  );
  box-shadow:
    /* 1 */
...
.button .button-inner span {
  ...
  -webkit-text-fill-color: transparent; /* ensure WebKit shows gradient text */
